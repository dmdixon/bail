...
\centering
\noindent\makebox[\textwidth]{%
\input{../tables/Total_Bond_Race_tukeyhsd.tex}}
\caption{TukeyHSD statistical post-hoc test for Total Bond and Race Correlation.}
\label{Tab:thsd_TBR}
\end{table}
...
\centering
\noindent\makebox[\textwidth]{%
\input{../tables/Total_Bond_Sex_tukeyhsd.tex}}
\caption{TukeyHSD statistical post-hoc test for Total Bond and Sex Correlation.}
\label{Tab:thsd_TBS}
\end{table}
...
\centering
\noindent\makebox[\textwidth]{%
\input{../tables/Age_Race_tukeyhsd.tex}}
\caption{TukeyHSD statistical post-hoc test for Age and Race Correlation.}
\label{Tab:thsd_AR}
\end{table}
...
\centering
\noindent\makebox[\textwidth]{%
\input{../tables/Age_Sex_tukeyhsd.tex}}
\caption{TukeyHSD statistical post-hoc test for Age and Sex Correlation.}
\label{Tab:thsd_AS}
\end{table}
...
\centering
\noindent\makebox[\textwidth]{%
\input{../tables/Number_of_Charges_Race_tukeyhsd.tex}}
\caption{TukeyHSD statistical post-hoc test for Number of Charges and Race Correlation.}
\label{Tab:thsd_NoCR}
\end{table}
...
\centering
\noindent\makebox[\textwidth]{%
\input{../tables/Number_of_Charges_Sex_tukeyhsd.tex}}
\caption{TukeyHSD statistical post-hoc test for Number of Charges and Sex Correlation.}
\label{Tab:thsd_NoCS}
\end{table}
...
\centering
\noindent\makebox[\textwidth]{%
\input{../tables/Number_of_Felonies_Race_tukeyhsd.tex}}
\caption{TukeyHSD statistical post-hoc test for Number of Felonies and Race Correlation.}
\label{Tab:thsd_NoFR}
\end{table}
...
\centering
\noindent\makebox[\textwidth]{%
\input{../tables/Number_of_Felonies_Sex_tukeyhsd.tex}}
...
\centering
\noindent\makebox[\textwidth]{%
\input{../tables/Number_of_Misd_Race_tukeyhsd.tex}}
...
\centering
\noindent\makebox[\textwidth]{%
\input{../tables/Number_of_Misd_Sex_tukeyhsd.tex}}
